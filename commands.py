...
#         word_str = view.substr(word).rstrip()

#         if self.indentifier_pattern.match(word_str):
#             # start of identifier
#             location = word.a
#         else:
#             location = locations[0]

#         thread = threading.Thread(target=self.query_completions, args=(view, location,))
#         thread.start()
...
#     def is_visible(self):
#         if CLIENT.is_initialized() and (
#             self.view.match_selector(0, "source.c")
#             or self.view.match_selector(0, "source.c++")
#         ):
#             return True
